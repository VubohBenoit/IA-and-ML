...
import streamlit_page.home as home
import streamlit_page.data as data
import streamlit_page.dashboard as dashboard
...
st.sidebar.markdown(
    ...
    <div class="sidebar-container">
        <img src="https://firebasestorage.googleapis.com/v0/b/chagest-eshop.appspot.com/o/Logo%2Flogo.png?alt=media&token=9b7a9042-f7d7-46c7-b321-bc5cd40cd335" 
             class="sidebar-logo" />
        <h1 class="sidebar-title">CHURN-INSIGHT</h1>
         </div>
    """,
